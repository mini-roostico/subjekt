...
interface Visitable {
    /**
     * Accepts the given visitor. This method is used to traverse the expression tree. [T] is the return type of the
     * visitor, and therefore is return by each visiting method.
     */
